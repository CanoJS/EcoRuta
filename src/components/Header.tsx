...
function Header({ setPage }: Props) {
  return (
    <nav className="flex justify-between items-center px-4 md:px-8 py-4 bg-white/70 backdrop-blur-md rounded-2xl mt-4 shadow-lg max-w-5xl w-[92%] mx-auto sticky top-4 z-50 border border-white/20">
